 ...
 */
 class Funcionarios extends model
 {
	...
	public function GetFunc_Servico($id){
		$array = array();
		$sql = $this->db->query("SELECT funcionario.nome, moto.modelo, moto.placa, moto.km_x_litro, moto.kmatual FROM tblfuncionario as funcionario INNER JOIN tblmoto as moto ON funcionario.idmoto = moto.id WHERE funcionario.id = $id");
